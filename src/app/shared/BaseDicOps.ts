...
export abstract class BaseDicOps<T, E extends T= T> {
    ...
    constructor(private dicSvr: any & IBaseDicService, private message: NzMessageService  ) {
    }
    protected queryList = () => {
        this.dicList$ = this.opsDic.onQuery(this.queryParams);
        this.total$ = this.opsDic.onQueryTotal(this.queryParams);
    }
